...
You can visit the repository webpage in |git_source| and download it as a zip file.

.. |git_source| raw:: html

    <a href="https://github.com/mineta/taskbuster-boilerplate.git" target="_blank">
    GitHub</a>
